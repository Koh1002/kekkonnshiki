...
const WEDDING_QUESTIONS = [
  ...
  // 第3問：絵画（ルノワール vs 新婦祖父）
  {
    order_index: 3,
    is_active: true,
    title: "ルノアールが書いた絵画はどちら？",
    description:
      "片方は印象派の巨匠・ルノワールの作品。片方は新婦のお祖父さまが遺した一枚。芸術の目利き、その腕前を。",
    option_a_label: "Ａ",
    option_b_label: "Ｂ",
    ...
    correct_option: "A",
    commentary:
      "正解は、ルノワールの名作「アネモネ」！ もう一方は、絵を趣味にされていた新婦のお祖父さまが描いたパンジーの絵。ご家族にとってかけがえのない宝物です。",
    timer_seconds: 45,
  },
  // 第4問：アクセサリー（ティファニー vs プチプラ）
  {
    ...
    option_a_label: "Ａ",
    option_b_label: "Ｂ",
    option_a_image: "/questions/q4_a.png",
    option_b_image: "/questions/q4_b.png",
    correct_option: "A",
    commentary:
      "正解は、新郎が新婦の誕生日にプレゼントしたティファニーのネックレス！ もう一方は、千円ほどのプチプラでした。新婦の宝物、輝きが違いますね。",
    timer_seconds: 30,
  },
  // 第5問：ストラディバリウス聞き比べ（音源は会場で別機材から再生）
  {
    order_index: 5,
    is_active: true,
    title: "ストラディバリウスの音はどちら？",
    description:
      "片方は名器ストラディバリウス、片方は普通のバイオリン。※これから会場で Ａ → Ｂ の順に流します。耳を澄ましてよく聞いてください。",
    option_a_label: "Ａ（先に再生）",
    option_b_label: "Ｂ（後に再生）",
    correct_option: "A",
    commentary:
      "正解は——名器ストラディバリウス！ 実は新婦、長年バイオリンを続けてきた腕前。音色の違い、聞き分けられましたか？",
    timer_seconds: 60,
  },
];
